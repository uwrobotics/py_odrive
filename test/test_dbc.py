...
def test_axis_calibration(dbc_db, axisID, AXIS_STATE_FULL_CALIBRATION_SEQUENCE, AXIS_STATE_FULL_CALIBRATION_SEQUENCE_CMD):
    ...
    assert msg == AXIS_STATE_FULL_CALIBRATION_SEQUENCE_CMD